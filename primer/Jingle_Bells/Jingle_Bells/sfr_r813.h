...
*   Version     : 1.20 (04-2-23)                                                    *
*                      correct comment cm0, cm1, ocd, vcr1, vcr2, d4int, adic,      *
*                                     tyzmr, prey, tysc, typr, pum, prez, tzsc,     *
*                                     tzpr, tyzoc, txmr, prex, tx, tcss, tc, inten, *
*                                     kien, tm0, u0brg, ucon, p0, p1, pd0, pd1, p3, *
*                                     pd3, p4, pd4, drr                             *
*                      correct define ucon                                          *
*                      add fmr4, fmr1, fmr0                                         *
*                 1.10 (03-11-19)                                                   *
...
#pragma ADDRESS    hr0_addr     0008H    /* High speed on-chip oscillator control register0 */

#pragma ADDRESS    aier_addr    0009H    /* Address match interrupt enable register */

#pragma ADDRESS    prcr_addr    000AH    /* Protect register */

#pragma ADDRESS    hr1_addr     000BH    /* High speed on-chip oscillator control register1 */
...
#pragma ADDRESS    vcr1_addr    0019H    /* Voltage detection register1 */

#pragma ADDRESS    vcr2_addr    001AH    /* Voltage detection register2 */

#pragma ADDRESS    int0f_addr   001EH    /* INT0 input filter select register */

#pragma ADDRESS    d4int_addr   001FH    /* Voltage detection interrupt register */
...
#define    pm10    pm1_addr.bit.b0       /* Data flash area access enable bit */
...
#define    hr00    hr0_addr.bit.b0       /* High-speed on-chip oscillator enable bit */
#define    hr01    hr0_addr.bit.b1       /* High-speed on-chip oscillator select bit */
...
#define    vc13    vcr1_addr.bit.b3      /* Voltage monitor flag */
...
#define    vc27    vcr2_addr.bit.b7      /* Voltage enable bit */
...
#define    d40     d4int_addr.bit.b0     /* Voltage detection interrupt enable bit */
...
#define    d46     d4int_addr.bit.b6     /* Voltage monitor mode select bit */
...
#define    tymod0  tyzmr_addr.bit.b0     /* TimerY operation mode bit */
#define    r1edg   tyzmr_addr.bit.b1     /* INT2/CNTR1 polarity switching bit */
#define    tywc    tyzmr_addr.bit.b2     /* TimerY write control bit */
#define    tys     tyzmr_addr.bit.b3     /* TimerY count start flag */
#define    tzmod0  tyzmr_addr.bit.b4     /* TimerZ Operation mode bit */
#define    tzmod1  tyzmr_addr.bit.b5     /* TimerZ Operation mode bit */
#define    tzwc    tyzmr_addr.bit.b6     /* TimerZ write control bit */
#define    tzs     tyzmr_addr.bit.b7     /* TimerZ count start flag */
...
#define    tyopl   pum_addr.bit.b4       /* TimerY output level latch */
...
#define    tzos    tyzoc_addr.bit.b0     /* TimerZ one-shot start bit */
#define    tyocnt  tyzoc_addr.bit.b1     /* TimerY programmable waveform generation output switching bit */
#define    tzocnt  tyzoc_addr.bit.b2     /* TimerZ programmable waveform generation output switching bit */
...
#define    tyck0   tcss_addr.bit.b2      /* TimerY count source select bit */
#define    tyck1   tcss_addr.bit.b3      /* TimerY count source select bit */
...
/*------------------------------------------------------
  UART1 baud rate generation register
------------------------------------------------------*/
...
#define    txd1sel ucon_addr.bit.b5      /* Port TxD11 switching bit */
#define    txd1en  ucon_addr.bit.b6      /* TxD10/RxD1 select bit */
...
#define    drr4    drr_addr.bit.b4       /* P14 capacity */
#define    drr5    drr_addr.bit.b5       /* P15 capacity */
#define    drr6    drr_addr.bit.b6       /* P16 capacity */
#define    drr7    drr_addr.bit.b7       /* P17 capacity */
...
#define    fmr46   fmr4_addr.bit.b6       /* Erase status */
